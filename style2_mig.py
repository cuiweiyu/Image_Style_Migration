...
#             pix_mean = np.mean(imag[row:row + w_times, col:col + h_times, :])
#             new_img[row, col, :] = pix_mean
...
def read_img(img_name):
    ...
    # np_img = np_img[300:300 + 224, 500:500 + 224, :]
    # np_img = down_sample(np_img)
...
style_val = read_img(style_img_path)[:, :, :, :3]
